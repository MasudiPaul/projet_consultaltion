...
<section class="about-inner py-lg-4 py-md-3 py-sm-3 py-3">
    <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
        <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">Répresentation</h3>
        <div class="row">
            <div class="col-lg-7 col-md-6 ">
                <div class="inner-abt-info">
                    ...
                    <p>
                        Chez RMB&A CONSULTING, nous offrons un service de représentation sur mesure pour vous aider à naviguer dans un monde d'opportunités. Que ce soit pour maximiser votre présence lors d'événements clés ou pour établir des relations durables avec des partenaires stratégiques, notre équipe d'experts est là pour vous accompagner. Découvrez comment nous pouvons transformer vos objectifs en succès."
            ...
            <div class="col-lg-5 col-md-6 inner-icon">
                <img src="IMAGECABINE/R5.jpg" alt="" class="img-fluid">
            </div>
            <div class="col-lg-7 col-md-6 ">
                <div class="inner-abt-info">
                    <div class="mb-lg-4 mb-md-3 mb-3 abut-inner-head">
