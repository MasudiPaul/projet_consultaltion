                    ...
                    <div>
                        <table class="table table-responsive table-bordered">
                            ...
                            foreach($donne as $ligne) {
                                ...
                                echo "<td><a href='https://mail.google.com/mail/u/0/#inbox/' class='btn btn-block '>" . $ligne['email'] . " </a></td>";
                                echo "<td>". $ligne['entreprise']."</td>";
                                echo "<td>". $ligne['sujet']."</td>";
                                echo "<td>". $ligne['commentaire']."</td>";
                                echo "<td><input name='btnEnregistrer' type='button' class='btn btn-primary' value='Envoyer'></td>";
